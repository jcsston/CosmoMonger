...
namespace CosmoMonger.Models
{
    ...
    partial void OnFriendIdChanged();
		...
		[Association(Name="User_BuddyList1", Storage="_Friend", ThisKey="FriendId", IsForeignKey=true)]
		public User Friend
		{
			get
			{
    ...
    partial void OnTargetCountChanged();
		...
		[Association(Name="Good_CombatGood", Storage="_CombatGoods", OtherKey="GoodId")]
    ...
    partial void OnAntiFriendIdChanged();
		...
		[Association(Name="User_IgnoreList1", Storage="_AntiFriend", ThisKey="AntiFriendId", IsForeignKey=true)]
    ...
    partial void OnCreditsLootedChanged();
		...
		[Association(Name="Combat_CombatGood", Storage="_CombatGoods", OtherKey="CombatId")]
		public EntitySet<CombatGood> CombatGoods
		{
			get
			{
		...
		[Association(Name="Ship_Combat", Storage="_Ship", ThisKey="AttackerShipId", IsForeignKey=true)]
		...
		[Association(Name="Ship_Combat1", Storage="_Ship1", ThisKey="DefenderShipId", IsForeignKey=true)]
    ...
    partial void OnVisibleToSenderChanged();
		...
		[Association(Name="User_Message1", Storage="_SenderUser", ThisKey="SenderUserId", IsForeignKey=true)]
    ...
    partial void OnTargetSystemArrivalTimeChanged();
		...
		[Association(Name="Ship_Combat", Storage="_InProgressCombats", OtherKey="AttackerShipId")]
		...
		[Association(Name="Ship_Combat1", Storage="_InProgressCombats1", OtherKey="DefenderShipId")]
    ...
    partial void OnSessionIDChanged();
		...
		[Association(Name="User_BuddyList1", Storage="_BuddyListsOn", OtherKey="FriendId")]
		...
		[Association(Name="User_IgnoreList1", Storage="_IgnoreListsOn", OtherKey="AntiFriendId")]
		...
		[Association(Name="User_Message1", Storage="_MessagesSent", OtherKey="SenderUserId")]
    ...
    partial void OnQuantityPickedUpChanged();
		...
		[Association(Name="Combat_CombatGood", Storage="_Combat", ThisKey="CombatId", IsForeignKey=true)]
		...
		[Association(Name="Good_CombatGood", Storage="_Good", ThisKey="GoodId", IsForeignKey=true)]
		public Good Good
		{
			get
			{
