...
namespace CosmoMonger.Models
{
	...
	public partial class Race : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private int _RacialEnemy;
		
		private System.Nullable<int> _RacialPreference;
    ...
    partial void OnRacialEnemyChanging(int value);
    partial void OnRacialEnemyChanged();
    partial void OnRacialPreferenceChanging(System.Nullable<int> value);
    partial void OnRacialPreferenceChanged();
    partial void OnHomeSystemChanging(int value);
    partial void OnHomeSystemChanged();
    ...
    partial void OnDescriptionChanged();
		...
		[Column(Storage="_RacialEnemy", DbType="Int")]
		public int RacialEnemy
		{
			get
			{
				return this._RacialEnemy;
			}
			set
			{
				if ((this._RacialEnemy != value))
				{
					this.OnRacialEnemyChanging(value);
					this.SendPropertyChanging();
					this._RacialEnemy = value;
					this.SendPropertyChanged("RacialEnemy");
					this.OnRacialEnemyChanged();
				}
			}
		}
		
		[Column(Storage="_RacialPreference", DbType="Int")]
		public System.Nullable<int> RacialPreference
		{
			get
			{
				return this._RacialPreference;
			}
			set
			{
				if ((this._RacialPreference != value))
				{
					this.OnRacialPreferenceChanging(value);
					this.SendPropertyChanging();
					this._RacialPreference = value;
					this.SendPropertyChanged("RacialPreference");
					this.OnRacialPreferenceChanged();
				}
			}
		}
		
		[Column(Storage="_HomeSystem", DbType="Int")]
		public int HomeSystem
		{
			get
			{
			...
			set
			{
				if ((this._HomeSystem != value))
				{
					...
					this.OnHomeSystemChanging(value);
					this.SendPropertyChanging();
					this._HomeSystem = value;
					this.SendPropertyChanged("HomeSystem");
					this.OnHomeSystemChanged();
				}
			}
		}
		
		[Column(Storage="_Description", DbType="varchar(1000)", CanBeNull=false)]
		...
		[Association(Name="CosmoSystem_Race", Storage="_CosmoSystem", ThisKey="HomeSystem", OtherKey="SystemId", IsForeignKey=true)]
    ...
    partial void OnHasBankChanged();
		...
		[Association(Name="CosmoSystem_Race", Storage="_Races", ThisKey="SystemId", OtherKey="HomeSystem")]
