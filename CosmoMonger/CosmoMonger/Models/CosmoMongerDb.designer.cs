...
namespace CosmoMonger.Models
{
    ...
    partial void DeleteNpcName(NpcName instance);
		...
		public System.Data.Linq.Table<PlayerRecord> PlayerRecords
		{
			get
			{
    ...
    partial void OnHitFactorChanged();
		...
		[Column(Storage="_HitFactor", DbType="Int NOT NULL")]
		public int HitFactor
		{
			get
			{
				return this._HitFactor;
			}
			set
			{
				if ((this._HitFactor != value))
				{
					this.OnHitFactorChanging(value);
					this.SendPropertyChanging();
		...
		[Association(Name="BaseShip_Ship", Storage="_Ships", ThisKey="BaseShipId", OtherKey="BaseShipId")]
		...
		[Association(Name="BaseShip_SystemShip", Storage="_SystemShips", ThisKey="BaseShipId", OtherKey="BaseShipId")]
		...
		[Association(Name="Weapon_BaseShip", Storage="_Weapon", ThisKey="InitialWeaponId", OtherKey="WeaponId", IsForeignKey=true)]
		...
		[Association(Name="JumpDrive_BaseShip", Storage="_JumpDrive", ThisKey="InitialJumpDriveId", OtherKey="JumpDriveId", IsForeignKey=true)]
		...
		[Association(Name="Shield_BaseShip", Storage="_Shield", ThisKey="InitialShieldId", OtherKey="ShieldId", IsForeignKey=true)]
    ...
    partial void OnBasePriceChanged();
		...
		[Association(Name="Weapon_BaseShip", Storage="_BaseShips", ThisKey="WeaponId", OtherKey="InitialWeaponId")]
		...
		[Association(Name="Weapon_Ship", Storage="_Ships", ThisKey="WeaponId", OtherKey="WeaponId")]
		public EntitySet<Ship> Ships
		{
			get
			{
		...
		[Association(Name="Weapon_SystemWeaponUpgrade", Storage="_SystemWeaponUpgrades", ThisKey="WeaponId", OtherKey="WeaponId")]
    ...
    partial void OnFriendIdChanged();
		...
		[Association(Name="User_BuddyList", Storage="_User", ThisKey="UserId", OtherKey="UserId", IsForeignKey=true)]
		public User User
		{
			get
			{
		...
		[Association(Name="User_BuddyList1", Storage="_Friend", ThisKey="FriendId", OtherKey="UserId", IsForeignKey=true)]
		public User Friend
		{
			get
			{
			...
			set
			{
							...
							|| (this._Friend.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.BuddyListsOn.Remove(this);
					}
					this._Friend.Entity = value;
					if ((value != null))
					{
						value.BuddyListsOn.Add(this);
    ...
    partial void OnTargetCountChanged();
		...
		[Association(Name="Good_ShipGood", Storage="_ShipGoods", ThisKey="GoodId", OtherKey="GoodId")]
		...
		[Association(Name="Good_SystemGood", Storage="_SystemGoods", ThisKey="GoodId", OtherKey="GoodId")]
    ...
    partial void OnAntiFriendIdChanged();
		...
		public int AntiFriendId
		{
			...
			set
			{
				...
				{
					if (this._AntiFriend.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
		...
		[Association(Name="User_IgnoreList", Storage="_User", ThisKey="UserId", OtherKey="UserId", IsForeignKey=true)]
		public User User
		{
			get
			{
		...
		[Association(Name="User_IgnoreList1", Storage="_AntiFriend", ThisKey="AntiFriendId", OtherKey="UserId", IsForeignKey=true)]
			...
			set
			{
							...
							|| (this._AntiFriend.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.IgnoreListsOn.Remove(this);
					}
					this._AntiFriend.Entity = value;
					if ((value != null))
					{
						value.IgnoreListsOn.Add(this);
    ...
    partial void OnBasePriceChanged();
		...
		[Association(Name="JumpDrive_BaseShip", Storage="_BaseShips", ThisKey="JumpDriveId", OtherKey="InitialJumpDriveId")]
		public EntitySet<BaseShip> BaseShips
		{
			get
			{
		...
		[Association(Name="JumpDrive_Ship", Storage="_Ships", ThisKey="JumpDriveId", OtherKey="JumpDriveId")]
		public EntitySet<Ship> Ships
		{
			get
			{
		...
		[Association(Name="JumpDrive_SystemJumpDriveUpgrade", Storage="_SystemJumpDriveUpgrades", ThisKey="JumpDriveId", OtherKey="JumpDriveId")]
	...
	public partial class Player : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private int _LastRecordSnapshotAge;
		
		private double _DistanceTraveled;
		
		private int _GoodsTraded;
		
		private EntitySet<PlayerRecord> _PlayerRecords;
    ...
    partial void OnLastRecordSnapshotAgeChanging(int value);
    partial void OnLastRecordSnapshotAgeChanged();
    partial void OnDistanceTraveledChanging(double value);
    partial void OnDistanceTraveledChanged();
    partial void OnGoodsTradedChanging(int value);
    partial void OnGoodsTradedChanged();
    #endregion
		
		public Player()
		{
			this._PlayerRecords = new EntitySet<PlayerRecord>(new Action<PlayerRecord>(this.attach_PlayerRecords), new Action<PlayerRecord>(this.detach_PlayerRecords));
			this._Race = default(EntityRef<Race>);
			this._Ship = default(EntityRef<Ship>);
			this._User = default(EntityRef<User>);
			OnCreated();
		...
		[Column(Storage="_LastRecordSnapshotAge", DbType="int NOT NULL")]
		public int LastRecordSnapshotAge
		{
			get
			{
				return this._LastRecordSnapshotAge;
			}
			set
			{
				if ((this._LastRecordSnapshotAge != value))
				{
					this.OnLastRecordSnapshotAgeChanging(value);
					this.SendPropertyChanging();
					this._LastRecordSnapshotAge = value;
					this.SendPropertyChanged("LastRecordSnapshotAge");
					this.OnLastRecordSnapshotAgeChanged();
				}
			}
		}
		
		[Column(Storage="_DistanceTraveled", DbType="float NOT NULL")]
		public double DistanceTraveled
		{
			...
			set
			{
				if ((this._DistanceTraveled != value))
				{
					this.OnDistanceTraveledChanging(value);
					this.SendPropertyChanging();
					this._DistanceTraveled = value;
					this.SendPropertyChanged("DistanceTraveled");
					this.OnDistanceTraveledChanged();
				}
			}
		}
		
		[Column(Storage="_GoodsTraded", DbType="int NOT NULL")]
		public int GoodsTraded
		{
			get
			{
				return this._GoodsTraded;
			}
			set
			{
				if ((this._GoodsTraded != value))
				{
					this.OnGoodsTradedChanging(value);
					this.SendPropertyChanging();
					this._GoodsTraded = value;
					this.SendPropertyChanged("GoodsTraded");
					this.OnGoodsTradedChanged();
				}
			}
		}
		
		[Association(Name="Player_PlayerRecord", Storage="_PlayerRecords", ThisKey="PlayerId", OtherKey="PlayerId")]
		public EntitySet<PlayerRecord> PlayerRecords
		{
			get
			{
			...
			set
			{
				this._PlayerRecords.Assign(value);
			}
		}
		...
		[Association(Name="User_Player", Storage="_User", ThisKey="UserId", OtherKey="UserId", IsForeignKey=true)]
		public User User
		{
			get
			{
		...
		private void attach_PlayerRecords(PlayerRecord entity)
		{
			this.SendPropertyChanging();
			entity.Player = this;
		}
		
		private void detach_PlayerRecords(PlayerRecord entity)
		{
			this.SendPropertyChanging();
			entity.Player = null;
		}
    ...
    partial void OnRacialPreferenceIdChanged();
		...
		[Association(Name="Race_Npc", Storage="_Npcs", ThisKey="RaceId", OtherKey="RaceId")]
		...
		[Association(Name="Race_Player", Storage="_Players", ThisKey="RaceId", OtherKey="RaceId")]
		...
		[Association(Name="Race_Race", Storage="_Races", ThisKey="RaceId", OtherKey="RacialEnemyId")]
		...
		[Association(Name="Race_Race1", Storage="_Races1", ThisKey="RaceId", OtherKey="RacialPreferenceId")]
		...
		[Association(Name="Race_CosmoSystem", Storage="_CosmoSystems", ThisKey="RaceId", OtherKey="RaceId")]
		...
		[Association(Name="CosmoSystem_Race", Storage="_CosmoSystem", ThisKey="HomeSystemId", OtherKey="SystemId", IsForeignKey=true)]
		...
		[Association(Name="Race_Race", Storage="_RacialEnemy", ThisKey="RacialEnemyId", OtherKey="RaceId", IsForeignKey=true)]
		...
		[Association(Name="Race_Race1", Storage="_RacialPreference", ThisKey="RacialPreferenceId", OtherKey="RaceId", IsForeignKey=true)]
    ...
    partial void OnCargoCostChanged();
		...
		[Association(Name="Shield_BaseShip", Storage="_BaseShips", ThisKey="ShieldId", OtherKey="InitialShieldId")]
		public EntitySet<BaseShip> BaseShips
		{
			get
			{
		...
		[Association(Name="Shield_Ship", Storage="_Ships", ThisKey="ShieldId", OtherKey="ShieldId")]
		public EntitySet<Ship> Ships
		{
			get
			{
		...
		[Association(Name="Shield_SystemShieldUpgrade", Storage="_SystemShieldUpgrades", ThisKey="ShieldId", OtherKey="ShieldId")]
    ...
    partial void OnCreditsChanged();
		...
		[Association(Name="Ship_Npc", Storage="_Npcs", ThisKey="ShipId", OtherKey="ShipId")]
		public EntitySet<Npc> Npcs
		{
			get
			{
		...
		[Association(Name="Ship_ShipGood", Storage="_ShipGoods", ThisKey="ShipId", OtherKey="ShipId")]
		public EntitySet<ShipGood> ShipGoods
		{
			get
			{
    ...
    partial void OnQuantityChanged();
		...
		[Association(Name="Good_ShipGood", Storage="_Good", ThisKey="GoodId", OtherKey="GoodId", IsForeignKey=true)]
		...
		[Association(Name="Ship_ShipGood", Storage="_Ship", ThisKey="ShipId", OtherKey="ShipId", IsForeignKey=true)]
		public Ship Ship
		{
			get
			{
    ...
    partial void OnRaceIdChanged();
		...
		[Association(Name="CosmoSystem_Race", Storage="_Races", ThisKey="SystemId", OtherKey="HomeSystemId")]
		public EntitySet<Race> Races
		{
			get
			{
		...
		[Association(Name="CosmoSystem_SystemGood", Storage="_SystemGoods", ThisKey="SystemId", OtherKey="SystemId")]
		public EntitySet<SystemGood> SystemGoods
		{
			get
			{
		...
		[Association(Name="CosmoSystem_SystemJumpDriveUpgrade", Storage="_SystemJumpDriveUpgrades", ThisKey="SystemId", OtherKey="SystemId")]
		public EntitySet<SystemJumpDriveUpgrade> SystemJumpDriveUpgrades
		{
			get
			{
		...
		[Association(Name="CosmoSystem_SystemShieldUpgrade", Storage="_SystemShieldUpgrades", ThisKey="SystemId", OtherKey="SystemId")]
		public EntitySet<SystemShieldUpgrade> SystemShieldUpgrades
		{
			get
			{
		...
		[Association(Name="CosmoSystem_SystemShip", Storage="_SystemShips", ThisKey="SystemId", OtherKey="SystemId")]
		public EntitySet<SystemShip> SystemShips
		{
			get
			{
		...
		[Association(Name="CosmoSystem_SystemWeaponUpgrade", Storage="_SystemWeaponUpgrades", ThisKey="SystemId", OtherKey="SystemId")]
		public EntitySet<SystemWeaponUpgrade> SystemWeaponUpgrades
		{
			get
			{
		...
		[Association(Name="Race_CosmoSystem", Storage="_Race", ThisKey="RaceId", OtherKey="RaceId", IsForeignKey=true)]
		public Race Race
		{
			get
			{
    ...
    partial void OnDemandChanged();
		...
		[Association(Name="Good_SystemGood", Storage="_Good", ThisKey="GoodId", OtherKey="GoodId", IsForeignKey=true)]
		public virtual Good Good
		{
			get
			{
		...
		[Association(Name="CosmoSystem_SystemGood", Storage="_CosmoSystem", ThisKey="SystemId", OtherKey="SystemId", IsForeignKey=true)]
    ...
    partial void OnPriceMultiplierChanged();
		...
		[Association(Name="CosmoSystem_SystemJumpDriveUpgrade", Storage="_CosmoSystem", ThisKey="SystemId", OtherKey="SystemId", IsForeignKey=true)]
		public CosmoSystem CosmoSystem
		{
			get
			{
    ...
    partial void OnPriceMultiplierChanged();
		...
		[Association(Name="Shield_SystemShieldUpgrade", Storage="_Shield", ThisKey="ShieldId", OtherKey="ShieldId", IsForeignKey=true)]
		public Shield Shield
		{
			get
			{
		...
		[Association(Name="CosmoSystem_SystemShieldUpgrade", Storage="_CosmoSystem", ThisKey="SystemId", OtherKey="SystemId", IsForeignKey=true)]
		public CosmoSystem CosmoSystem
		{
			get
			{
    ...
    partial void OnPriceMultiplierChanged();
		...
		[Association(Name="CosmoSystem_SystemShip", Storage="_CosmoSystem", ThisKey="SystemId", OtherKey="SystemId", IsForeignKey=true)]
		public CosmoSystem CosmoSystem
		{
			get
			{
    ...
    partial void OnPriceMultiplierChanged();
		...
		[Association(Name="CosmoSystem_SystemWeaponUpgrade", Storage="_CosmoSystem", ThisKey="SystemId", OtherKey="SystemId", IsForeignKey=true)]
		public CosmoSystem CosmoSystem
		{
			get
			{
		...
		[Association(Name="Weapon_SystemWeaponUpgrade", Storage="_Weapon", ThisKey="WeaponId", OtherKey="WeaponId", IsForeignKey=true)]
		public Weapon Weapon
		{
			get
			{
	...
	public partial class User : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<IgnoreList> _IgnoreListsOn;
    ...
    partial void OnSessionIDChanged();
		...
		public User()
		{
			...
			this._BuddyListsOn = new EntitySet<BuddyList>(new Action<BuddyList>(this.attach_BuddyListsOn), new Action<BuddyList>(this.detach_BuddyListsOn));
		...
		[Association(Name="User_BuddyList", Storage="_BuddyLists", ThisKey="UserId", OtherKey="UserId")]
		...
		[Association(Name="User_BuddyList1", Storage="_BuddyListsOn", ThisKey="UserId", OtherKey="FriendId")]
		public EntitySet<BuddyList> BuddyListsOn
		{
			get
			{
				return this._BuddyListsOn;
			}
			set
			{
				this._BuddyListsOn.Assign(value);
			}
		}
		
		[Association(Name="User_IgnoreList", Storage="_IgnoreLists", ThisKey="UserId", OtherKey="UserId")]
		...
		[Association(Name="User_IgnoreList1", Storage="_IgnoreListsOn", ThisKey="UserId", OtherKey="AntiFriendId")]
		public EntitySet<IgnoreList> IgnoreListsOn
		{
			get
			{
				return this._IgnoreListsOn;
			}
			set
			{
				this._IgnoreListsOn.Assign(value);
			}
		}
		
		[Association(Name="User_Message", Storage="_Messages1", ThisKey="UserId", OtherKey="RecipientUserId")]
		...
		private void attach_BuddyListsOn(BuddyList entity)
		{
			this.SendPropertyChanging();
			entity.Friend = this;
		}
		
		private void detach_BuddyListsOn(BuddyList entity)
		{
			this.SendPropertyChanging();
			entity.Friend = null;
		}
		...
		private void attach_IgnoreListsOn(IgnoreList entity)
		{
			this.SendPropertyChanging();
			entity.AntiFriend = this;
		}
		
		private void detach_IgnoreListsOn(IgnoreList entity)
		{
			this.SendPropertyChanging();
			entity.AntiFriend = null;
		}
		...
		private void detach_MessagesSent(Message entity)
		{
			this.SendPropertyChanging();
	...
	[Table(Name="dbo.PlayerRecord")]
	public partial class PlayerRecord : INotifyPropertyChanging, INotifyPropertyChanged
	{
		
		private static PropertyChangingEventArgs emptyChangingEventArgs = new PropertyChangingEventArgs(String.Empty);
		
		private int _PlayerRecordId;
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnPlayerRecordIdChanging(int value);
    partial void OnPlayerRecordIdChanged();
    partial void OnPlayerIdChanging(int value);
    partial void OnPlayerIdChanged();
    ...
    partial void OnGoodsTradedChanged();
		...
		[Column(Storage="_PlayerRecordId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int PlayerRecordId
		{
			get
			{
				return this._PlayerRecordId;
			}
			set
			{
				if ((this._PlayerRecordId != value))
				{
					this.OnPlayerRecordIdChanging(value);
					this.SendPropertyChanging();
					this._PlayerRecordId = value;
					this.SendPropertyChanged("PlayerRecordId");
					this.OnPlayerRecordIdChanged();
				}
			}
		}
		...
		[Association(Name="Player_PlayerRecord", Storage="_Player", ThisKey="PlayerId", OtherKey="PlayerId", IsForeignKey=true)]
			...
			set
			{
							...
							|| (this._Player.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.PlayerRecords.Remove(this);
					}
					this._Player.Entity = value;
					if ((value != null))
					{
						value.PlayerRecords.Add(this);
